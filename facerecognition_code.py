...
# Face1
face1_image = face_recognition.load_image_file("akash.jpg")
face1_face_encoding = face_recognition.face_encodings(face1_image)[0]
# Face2
face2_image = face_recognition.load_image_file("adarsh.jpg")
face2_face_encoding = face_recognition.face_encodings(face2_image)[0]
# Face3
face3_image = face_recognition.load_image_file("pradyuman.jpg")
face3_face_encoding = face_recognition.face_encodings(face3_image)[0]
# Face4
face4_image = face_recognition.load_image_file("anand.jpg")
